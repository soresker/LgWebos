class Publishment_Reader{

    static currentPublishment = 0;
    static templateList = [];
    static calendarList = [];
    static worker = 0;
    static currentTemplate = 0;
    static templateInfo = "";  
...
static parseLatestPublishment =  function(data) {
...
static parseCalendars = function() {
...
static  parseTemplates = function() {
 ...
 static  parseFrames = function(templateInfo, templateInfoToParse) {
 ...
 static  parsePlaylists = function(templateInfo, templateInfoToParse) {
...
static  parseContents = function(playlistInfo, playlistInfoToParse) {
 ...
 static  parseBasicAttributes = function(info, object,uniqId) {
...
static clearPublisment =  function() {
...
static clearCurrentTemplate =  function() {
